...
$image_url = wp_get_attachment_url( $thumbnail_id ); 
        echo '<div class="fill_icon control '.$cat->slug.' ?>" data-filter=".'.$cat->slug.'">';
...
?><div class="product_wrap <?php echo $catslug ?>" data-ref="mixitup-target" >
  ...
  <form action="http://mutazbarshim.net/api/cart/add/" method="post">
          <div class="card flex-md-row mb-4">
            <div class="card-body d-flex flex-column align-items-start">
             <h1><?php echo $product->get_title(); ?></h1>
                <div class="color_box">
                 <!------ <p>choose your color</p>-------->
                 <p class="color_text">CHOOSE YOUR COLOR</p>
                  <?php 
     ...
     $variations = $product->get_available_variations();
        ...
        ?>
         ...
         <input type="radio" value="<?php echo $variation_id; ?>" data-item-image="<?php echo $item_image; ?>" data-price="<?php echo $price; ?>" data-item-title="<?php echo $item_title; ?>"   id="<?php echo $mb_color; ?>-<?php echo $product->get_id();?>"  class="<?php echo $mb_color; ?>"  name="color"   <?php echo  ($key ==-1) ? 'checked': '';?>>
                  <label   for="<?php echo $mb_color; ?>-<?php echo $product->get_id();?>" data-price="<?php echo $price; ?>"><?php echo $mb_color; ?></label>
        <?php
         }
                }
                  else{?>
                    <input type="radio" value="<?php echo $product->get_id(); ?>">
     ...
     ?>
      ...
      <div class="unit_box">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <div class="input-group-text" id="btnGroupAddon2">unit</div>
                          ...
                          <input type="button" value="-" class="button-minus" data-field="stQuantity">
                      <input type="text" step="1" max="" class="form-control stQuantity quantity-field" min="1" value="1" name="stQuantity" placeholder="number" aria-label="Input group example" aria-describedby="btnGroupAddon2">
                     <input type="button" value="+" class="button-plus" data-field="stQuantity">
            ...
            <div class="image_box">
                            <img class="card-img-right" alt="Thumbnail" src="<?php echo $item_image; ?>">
                            <div class="price_tag <?php echo $mb_color; ?>">
                                ...
                                <span class="v_price"><sub>$</sub> <?php echo $price; ?><div></div></span>
                            </div>
                      </div>
